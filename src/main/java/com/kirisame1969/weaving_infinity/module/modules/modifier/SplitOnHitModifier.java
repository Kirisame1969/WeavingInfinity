...
public class SplitOnHitModifier implements ISpellModule {
    ...
    // 分裂角度间隔
    private static final float ANGLE_BETWEEN_SHOTS = 120.0f;
     ...
     */
    public static void createSplitEffect(ServerLevel level, Entity caster, Entity hitEntity, ISpellModule originalModule, ModuleExecutionContext context) {
        if (hitEntity == null || !(caster instanceof net.minecraft.world.entity.LivingEntity livingCaster)) return;
        ...
        for (int i = 0; i < SPLIT_COUNT; i++) {
            ...
            float yaw = i * ANGLE_BETWEEN_SHOTS;
            ...
            // 使用原始模块克隆投射物
            originalModule.cloneProjectile(context, hitPos, direction);
        }
    }
}